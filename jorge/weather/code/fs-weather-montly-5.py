...
# include - OK Tested!
## Queries at province level!!
## Year/Month/Day is today() date
def fSoupFrames(province, start_year, max_pages):
    ...
    for i in range(max_pages):
        ...
        queryYear = "StartYear={}&EndYear=2018&Year=2018&Month=10&Day=20&selRowPerPage=100&txtCentralLatMin=0&txtCentralLatSec=0&txtCentralLongMin=0&txtCentralLongSec=0&".format(start_year)
...
for index, row in monthly_stations.iterrows():
    ...
    allStations = lookUpStation(row["StationID"], sd, ed, 
